	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<div class="panel panel-default">
			...
			<div class="panel-body">
					...
					<div class="form-group has-feedback">
						<div class="input-group">
							...
							<input class="form-control has-success" type="text"
								value="${param.keyword}" name="keyword" placeholder="请输入查询条件">
						</div>
					</div>
				...
				<a href="admin/to/add.html" class="btn btn-success"
									...
									<tr>
										...
										<td><a
											...
											class="btn btn-success btn-xs"><i
												class="glyphicon glyphicon-check"></i></a> </a> <!-- 旧代码 --> <!-- <button type="button" class="btn btn-primary btn-xs">
                                        <i class=" glyphicon glyphicon-pencil"></i>
                                    </button> --> <!-- 新代码 --> <a
											href="admin/to/edit.html?adminId=${admin.id}&pageNum=${pageInfo.pageNum}&keyword=${param.keyword }"
											class="btn btn-primary btn-xs"> <i
												class=" glyphicon glyphicon-pencil"></i>
										</a> <a
											href="admin/delete/${admin.id }/${pageInfo.pageNum }/${param.keyword }.html"
